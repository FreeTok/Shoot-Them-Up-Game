...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASTUPlayerController()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ASTUPlayerController_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ASTUPlayerController, 1167173394);
